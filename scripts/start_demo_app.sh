...
#worked
java -jar target/intel-grpc-fd19-alpha-1.0.jar --maxSeqCnt 25 --parallelCam 1 --nbrCameras 2 --nbrCameraTuples 1 --parallelCube 2 --nbrCubes 2 --timeout 100000 --shutdownWaitTS 100000 --nThreads 2 --nCapacity 100 --inputFile file:///Users/vkbalakr/Downloads/test-img.jpg --outputFile file:///tmp --options test --outputPath /tmp/demo --local true --host localhost --port 50051 --action all